...
export class Connection extends android.telecom.Connection {

    private static TAG = Connection.class.getSimpleName();
    ...
    public onAnswer(): void {
        ...
        // TODO: review this code, this code should be used observation method. 
